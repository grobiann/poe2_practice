...
public class MinimapWalkableDrawer : IWalkableDrawer
{
    public void DrawWalkable(Texture2D texture)
    {
        NavMeshTriangulation triangulation = NavMesh.CalculateTriangulation();
        DrawWalkableTexture(texture, triangulation.vertices, triangulation.indices);
    }

    private void DrawWalkableTexture(Texture2D texture, Vector3[] vertices, int[] triangles)
    {
